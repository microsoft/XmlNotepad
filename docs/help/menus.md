...
- **Cut** Copy the selected node to the clipboard (and its children) and remove that node from the tree. See [Clipboard support](../clipboard/).
...
- **Find...** Brings up the [find dialog](../find/).
- **Replace...** Brings up the [replace dialog](../find/).
...
- **Options...** Display the [Options Dialog](../options/).
- **Schemas...** Display the [Schemas Dialog](../schemas/).
